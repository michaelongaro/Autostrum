    ...
    >
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          ...
          } rounded-lg font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground [&[data-state=open]>svg]:rotate-180`,
          className,
        )}
        {...props}
      >
