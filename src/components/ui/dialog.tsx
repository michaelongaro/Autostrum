...
>(({ className, children, renderCloseButton = true, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      ...
      {renderCloseButton && (
        <DialogPrimitive.Close className="baseFlex data-[state=open]:text-muted absolute right-2 top-2 size-8 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-primary">
          <X className="h-4 w-4" />
