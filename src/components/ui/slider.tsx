  ...
  return (
    ...
    >
      ...
      <SliderPrimitive.Thumb
        ...
        // also btw... this is getting applied to the actual thumb, not the span wrapper that actually
        // needs the transition property... figure ou thow to get it on that one
