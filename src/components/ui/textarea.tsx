...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ className, ...props }, ref) => {
    return (
      <textarea
        className={cn(
          // not sure what property to transition because we can't transition-all because it will mess
          // with the ux of the height of the textarea when it's being resized
