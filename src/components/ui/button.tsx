...
const buttonVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm shadow-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-foreground/70 disabled:pointer-events-none disabled:opacity-50 select-none",
  {
    ...
    variants: {
      variant: {
        ...
        toggle: "hover:brightness-95 active:brightness-90",
