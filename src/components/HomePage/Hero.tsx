...
function Hero({
  ...
  return (
    <div className="baseVertFlex z-10 my-24 !flex-nowrap gap-16 md:gap-24">
      <div className="heroGlassmorphic baseVertFlex w-5/6 items-start gap-2 rounded-xl p-4 shadow-sm sm:w-auto md:gap-4 md:p-8">
      ...
      <div className="baseVertFlex heroGlassmorphic w-11/12 !flex-nowrap gap-8 rounded-xl p-4 shadow-sm sm:w-4/5 md:max-w-[550px] md:gap-4 md:p-8 xl:w-[950px] xl:max-w-[950px]">
