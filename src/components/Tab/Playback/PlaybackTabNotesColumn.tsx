...
interface TabNotesColumn {
  index: number; // w/ respect to entire tab/section being played
  columnData: string[];
...
function PlaybackTabNotesColumn({
  ...
  const [lastModifiedPalmMuteNode, setLastModifiedPalmMuteNode] = useState<LastModifiedPalmMuteNodeLocation | null>(
    null
  );
  ...
  return (
    <CarouselItem
      ...
      className="baseVertFlex cursor-default h-[271px]"
    >

    {/* TODO: include primary colored highlight section here, suing index prop passed in above */}
            ...
            <Fragment key={index}>
              ...
              {index > 0 && index < 7 && (
                <div
                  ...
                  className="baseFlex w-[35px] relative basis-[content]"
                >
                  <div
                    // style={{
