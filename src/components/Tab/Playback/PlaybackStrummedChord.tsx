    ...
    <>
      ...
      {strumIndex === -1 && (
        <div
          ...
          className="baseVertFlex mb-[71px] h-[144px] w-4 shrink-0 border-y-2 border-foreground mobilePortrait:h-[168px]"
        >
      ...
      {strumIndex !== -1 && (
        <div
          ...
          className="baseVertFlex relative mb-[71px] h-[144px] w-[40px] pb-4 mobilePortrait:h-[168px]"
        >
          {bpmToShow && (
