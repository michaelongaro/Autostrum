      ...
      <AnimatePresence mode="wait">
        {showMobileHeaderModal && (
          <motion.div
            ...
            className="baseVertFlex mobileHeaderGradient fixed top-16 z-[-1] max-h-[80dvh] w-full max-w-lg !justify-start overflow-y-auto rounded-b-2xl border-t border-foreground shadow-lg"
          >
