  ...
  return (
    <div className="baseVertFlex relative w-full !items-start gap-2 lg:!flex-row lg:!justify-between">
      ...
      {!isAboveLgViewport && (
        ...
        >
          <DrawerPortal>
            <DrawerContent className="baseVertFlex fixed bottom-0 left-0 right-0 h-[75dvh] max-h-[500px] !items-start !justify-start rounded-t-2xl bg-pink-100 pt-4 text-pink-950">
              <VisuallyHidden>
