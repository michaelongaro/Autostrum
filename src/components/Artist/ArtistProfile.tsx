          ...
          {isFetchingArtist ? (
            ...
            >
              <div className="baseVertFlex !items-start gap-1 sm:gap-0">
                ...
                <div className="pulseAnimation h-[45px] w-36 rounded-md bg-secondary-active md:h-[54px]"></div>
              </div>

              <div className="baseFlex gap-4 font-medium sm:text-lg">
                <div className="baseFlex gap-2">
                  <BsMusicNoteBeamed className="size-4 sm:size-5" />
                  <div className="pulseAnimation h-5 w-8 rounded-md bg-secondary-active"></div>
                  <span>Songs</span>
                </div>
                ...
                <div className="baseFlex gap-2">
                  ...
                  <div className="pulseAnimation h-5 w-10 rounded-md bg-secondary-active"></div>
                  <span>Views</span>
                </div>
              </div>
            </motion.div>
