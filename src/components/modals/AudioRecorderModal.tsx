...
function AudioRecorderModal() {
  ...
  function handleSaveRecording() {
    ...
    // console.log(
    //   "setting with",
    //   localRecordedAudioFile,
    //   localRecordedAudioFile instanceof Blob
    // );
    ...
    >
      ...
      <div className="baseVertFlex min-h-[350px] w-[350px] gap-10 rounded-md bg-pink-400 p-2 shadow-sm sm:w-[400px] md:p-4">
        ...
        <div className="baseVertFlex lightestGlassmorphic max-w-[23rem] gap-2 rounded-md p-2 text-sm">
          ...
          Thank you for creating an official recording of your tab to play along
          with! Make sure your microphone is closeby and has a clear pickup of
          your guitar.
        </div>
