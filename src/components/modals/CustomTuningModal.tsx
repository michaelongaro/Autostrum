  ...
  return (
    ...
    >
      ...
      >
        <div
          tabIndex={-1}
          className="baseVertFlex modalGradient relative max-w-[95vw] gap-8 rounded-lg border p-4 shadow-sm xl:w-96"
        >
